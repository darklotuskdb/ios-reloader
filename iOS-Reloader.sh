...
echo -e '\n[#] Please install "\e[33mApple File Conduit 2\e[0m" (https://cydia.saurik.com/package/com.saurik.afc2d/) manually, as we have observed that it is not functioning properly on a few iOS devices.'
